...
def getGameName(discord_username):
    ...
    users = {
    'Theeight#7284':                 {'name': 'Theeightc',        'region': 'EUW1'},
    'LadyMorgie#1930':               {'name': 'Lady Morgie',      'region': 'EUW1'},
    'AGRIS#9475':                    {'name': 'YOU GUYS ARE BAD', 'region': 'EUW1'},
    'Ifchix#4022':                   {'name': 'botinjsh',         'region': 'EUW1'},
    'MitraisBandīts#6877':           {'name': 'Kapars420',        'region': 'EUW1'},
    'Warksman#2353':                 {'name': '4dren4linRush',    'region': 'EUW1'},
    'kampulis#0424':                 {'name': 'BoneLord69',       'region': 'EUW1'},
    'MissGoldfish#8289':             {'name': 'MissGoldfish',     'region': 'EUW1'},
    'Karma#0180':                    {'name': 'That Karma',       'region': 'EUW1'},
    'Eternal Wanderer#2116':         {'name': 'Binoklis',         'region': 'EUW1'},
    'gesmen#3476':                   {'name': 'gesmenits',        'region': 'EUW1'},
    'EddyThe3agle#6782':             {'name': 'JustifyEA',        'region': 'EUW1'},
    'FatAndBeautiful#8714':          {'name': 'Proctologist',     'region': 'EUW1'},
    'Rodzs/Mini#7379':               {'name': 'Rodzs',            'region': 'EUW1'},
    'WhiteCave#8762':                {'name': 'WhiteCave',        'region': 'EUW1'},
    'DimoniuS#8198':                 {'name': 'GT NiknaiS PapS',  'region': 'EUW1'},
    'notacop#0631':                  {'name': 'Erronnannet',      'region': 'EUW1'},
    'Shabba#1086':                   {'name': 'JZX Shabba',       'region': 'EUN1'},
    'eidukS#0022':                   {'name': 'eidukxx',          'region': 'EUN1'},
    'Antidisestablishmentaria#4722': {'name': 'deporteetaa Dora', 'region': 'EUW1'},
    'Legendary Citronskeys#1997':    {'name': 'Citronskeys',      'region': 'EUW1'},
    'b1bop#2173':                    {'name': 'b1bop',            'region': 'EUW1'},
    'goofinjsh#8083':                {'name': 'Goofinjsh',        'region': 'EUW1'},
    'Lv_Chigorins#1640':             {'name': 'Lvchigorins',      'region': 'EUW1'},
    'vitaminz88#0036':               {'name': 'vitaminz88',       'region': 'EUW1'},
    'Milkyu#0992':                   {'name': 'Milkyu',           'region': 'EUW1'},
    'Jaanisjc#1108':                 {'name': 'YOU GUYS ARE BAD', 'region': 'EUW1'}
 }
